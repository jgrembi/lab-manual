...
### After completing the CITI trainings, they will be populated into Penn State's Safety Tracking System (CATS).
...
- Directions for logging into CATS and editing your profile can be found [here](https://researchsupport.psu.edu/orp/ibc/events-training-resources/update-personnel-experience-in-cats-safety/).
...
<!--chapter:end:04-reproducibility.Rmd-->
...
<!--chapter:end:05-code-repositories.Rmd-->
...
Consider using RStudio's [code folding](https://support.rstudio.com/hc/en-us/articles/200484568-Code-Folding-and-Sections) feature to collapse and expand different sections of your code. Any comment line with at least four trailing dashes (-), equal signs (=), or pound signs (#) automatically creates a code section. See the above link for more info.
...
<!--chapter:end:06-coding-practices.Rmd-->
...
<!--chapter:end:07-coding-style.Rmd-->
...
<!--chapter:end:09-data-masking.Rmd-->
...
<!--chapter:end:12-reproducible-environments.Rmd-->
...
<!--chapter:end:13-code-publication.Rmd-->
...
<!--chapter:end:14-data-publication.Rmd-->
