...
\item
  They will review your immunization record and recommend a booster or new vaccination series, if needed. A normal course for an unvaccinated person is two shots one month apart, a booster would be just one shot. Student vaccinations are given at the Student Health Center on campus, staff and employees get theirs at Occupational Health (near the hospital).
\end{itemize}
